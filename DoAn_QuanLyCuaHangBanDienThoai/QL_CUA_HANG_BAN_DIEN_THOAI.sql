...
Alter table KHO
	ADD CONSTRAINT CK_SODIENTHOAIKHO CHECK (SODIENTHOAIKHO LIKE '[0-9]%' AND LEN(SODIENTHOAIKHO) <= 11),
		CONSTRAINT CK_SOLUONGSP CHECK (SOLUONGSP > 0)
----------------------Bảng NHAPKHO----------------------
Alter table NHAPKHO
...
ALTER TABLE XUATKHO
	ADD	CONSTRAINT CK_SOLUONG_XUATKHO CHECK (SOLUONG > 0),
		CONSTRAINT CK_DONGIA_XUATKHO CHECK (DONGIA > 0);
...
------------------BẢNG CHI TIẾT SẢN PHẨM - SẢN PHẨM - TÀI KHOẢN------------------------------
...
----MẬT KHẨU PHẢI BẮT ĐẦU BẰNG CHỮ CÁI HOA VÀ THEO 9 CHỮ SỐ KHÔNG DÀI HƠN 10 KÍ TỰ---- VD: A123456789
--ALTER TABLE TAIKHOAN ADD CONSTRAINT CK_MATKHAU CHECK ((MATKHAU LIKE '[A-Z][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]') AND (LEN(MATKHAU)=10)
...
insert into NHAPKHO
values
('NHAP001', 'SP001', 'KHO01', 100, 50000000, '2023-10-28', 'NCC001'),
('NHAP002', 'SP002', 'KHO02', 150, 60000000, '2023-10-29', 'NCC002'),
('NHAP003', 'SP003', 'KHO03', 200, 45000000, '2023-10-30', 'NCC003'),
('NHAP004', 'SP004', 'KHO04', 120, 55000000, '2023-11-01', 'NCC004'),
('NHAP005', 'SP005', 'KHO05', 180, 70000000, '2023-11-02', 'NCC005')
select * from NHAPKHO

INSERT INTO XUATKHO (MAXUATKHO, MAKHO, MASANPHAM, SOLUONG, DONGIA, NGAYXUAT)
VALUES
('XUAT1', 'KHO01', 'SP001' ,50, 6000000, '2023-10-16'),
('XUAT2', 'KHO02', 'SP002' ,70, 7000000, '2023-10-16'),
('XUAT3', 'KHO03', 'SP003' ,90, 7500000, '2023-10-17'),
('XUAT4', 'KHO04', 'SP004' ,60, 6500000, '2023-10-17'),
('XUAT5', 'KHO05', 'SP005' ,80, 8000000, '2023-10-18');
select * from XUATKHO
INSERT INTO CHITIETSANPHAM (MACHITIETSANPHAM, MASANPHAM, TENSANPHAM, GIA, MAUSAC, MOTASANPHAM, HINHANH)
VALUES
    ('CTSP1', 'SP001', 'Samsung', 5000000, N'Đen', N'Mô tả sản phẩm 1', 'image1.jpg'),
    ('CTSP2', 'SP002', 'iPhone', 6000000, N'Trắng', N'Mô tả sản phẩm 2', 'image2.jpg'),
    ('CTSP3', 'SP003', 'Xiaomi', 4500000, N'Xanh', N'Mô tả sản phẩm 3', 'image3.jpg'),
    ('CTSP4', 'SP004', 'Google Pixel', 5500000, N'Đỏ', N'Mô tả sản phẩm 4', 'image4.jpg'),
    ('CTSP5', 'SP005', 'OnePlus', 7000000, N'Vàng', N'Mô tả sản phẩm 5', 'image5.jpg'),
    ('CTSP6', 'SP006', 'Huawei', 4000000, N'Xanh', N'Mô tả sản phẩm 6', 'image6.jpg'),
    ('CTSP7', 'SP007', 'Sony Xperia', 7000000, N'Vàng', N'Mô tả sản phẩm 7', 'image7.jpg'),
    ('CTSP8', 'SP008', 'LG', 2900000, N'Đỏ', N'Mô tả sản phẩm 8', 'image8.jpg'),
    ('CTSP9', 'SP009', 'Nokia', 7300000, N'Tím', N'Mô tả sản phẩm 9', 'image9.jpg'),
    ('CTSP10', 'SP010', 'Motorola', 6000000, N'Chàm', N'Mô tả sản phẩm 10', 'image10.jpg');
...
values('DH001','KH001','04-11-2023',N'Đã xử lý'),
	('DH003','KH001','2023-11-01',N'Chưa xử lý'),
	('DH004','KH001','2023-11-02',N'Đã xử lý'),
	('DH005','KH001','2023-11-03',N'Đã xử lý'),
	('DH006','KH001','2023-10-30',N'Chưa xử lý'),
	('DH007','KH001','2023-10-12',N'Đã xử lý'),
	('DH008','KH001','2023-10-04',N'Đã xử lý'),
	('DH009','KH001','2023-10-11',N'Chưa xử lý'),
	('DH0010','KH001','2023-10-27',N'Đã xử lý')
select * from DONHANG

insert into CHITIETDONHANG(MACHITIETDONHANG,MADONHANG,MASANPHAM,SOLUONG,KIEMTRATHANHTOAN)
values('CTDH001','DH001','SP001',200,1),
	('CTDH002','DH004','SP002',150,1),
	('CTDH003','DH003','SP003',80,1),
	('CTDH004','DH004','SP004',370,1),
	('CTDH005','DH005','SP005',500,1),
	('CTDH006','DH006','SP006',100,1),
	('CTDH007','DH007','SP007',30,1),
	('CTDH008','DH008','SP008',542,1),
	('CTDH009','DH009','SP009',212,1),
	('CTDH010','DH0010','SP010',132,1)
select * from CHITIETDONHANG

-- Dữ liệu cho bảng THANHTOANDONHANG
INSERT INTO THANHTOANDONHANG (MATHANHTOANDONHANG, MADONHANG, NGAYTHANHTOAN, TONGTIEN)
VALUES
('TT001', 'DH001', '2023-10-16', 15000000),
('TT002', 'DH007', '2023-10-16', 20000000),
('TT003', 'DH003', '2023-10-17', 25000000),
('TT004', 'DH004', '2023-10-18', 30000000),
('TT005', 'DH005', '2023-10-19', 40000000);
...
create proc sp_ThemXuatKho @MaXuatKho char(10), @MaSP char(10), @MaKho char(10), @SoLuong int, @DonGia float,
			@NgayXuat date  
as
	if exists(select * from XUATKHO where MAXUATKHO = @MaXuatKho)
		...
		insert into XUATKHO
		values(@MaXuatKho,  @MaKho ,@MaSP, @SoLuong, @DonGia, @NgayXuat)
select * from KHO
select * from XUATKHO
exec sp_ThemXuatKho 'XUAT7', 'SP001', 'KHO03', 100, 50000000, '2023-11-11'
exec sp_ThemXuatKho 'XUAT7', 'KHO01', 'SP003', 150, 50000000, '2023-12-1'
...
GO
exec top5donhangcaonhat2 2023, 10
...
SELECT * FROM NHAPKHO
go
-----Tính tổng số tiền cửa hàng thu được của từng sản phẩm bán ra của tháng X trong năm X----
...
GO
select * from THANHTOANDONHANG
--DROP PROC Tongdoanhthutheothang
exec tongdoanhthutheothang 10, 2023
go
