        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
                ...
                errorProvider3.GetError(txtEmail) == "" && errorProvider4.GetError(txtDiaChi) == "" && errorProvider5.GetError(cboChucVu) == "")
            {
                try
                {
                    ...
                    string truyvan = "EXEC ThemNhanVien @TenNV = N'" + txtHoTen.Text + "', @SoDienThoai = '" + txtSDT.Text + "', @Email = '" + txtEmail.Text + "', @DiaChi = N'" + txtDiaChi.Text + "', @GioiTinh = N'" + gt + "', @ChucVu = N'" + cboChucVu.SelectedItem + "'; ";
                    ...
                    {
                        MessageBox.Show("Không thể lấy thông tin mã nhân viên mới.");
                    }
                    db.Close();
                }
                catch (Exception ex)
